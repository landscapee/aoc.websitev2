<template>
    <div style="width:100%;height:100%;" id="app">
        ...
        <el-dialog class="appDialog" title="" :close-on-click-modal="false" center :visible.sync="dialogFormVisible" :before-close="close">
...
export default {
    ...
    methods: {
        ...
        checkToken(user) {
            this.$request
                .post('login', `/authorizeIsLogin?userId=${user.id}&auth=${user.auth}`, null, false)
                .then((res) => {
