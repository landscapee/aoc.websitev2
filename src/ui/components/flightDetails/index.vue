<template>
    <div>
        <el-dialog title="航班保障进程" :close-on-click-modal="false" center :visible.sync="dialogFormVisible" :before-close="close">
            <div class="top">
                    ...
                    <div class="content">
                        <div class="contentTop">
                            <div class="contentTop_left">
                                <span>
                                    <icon-svg iconClass="hangban"></icon-svg><span class="fo">{{opt.flightNo||''}}</span>
                                </span>
                            ...
                            <div class="contentTop_right">
                                ...
                                <span>
                                    <icon-svg iconClass="riqi2"></icon-svg>{{opt.operationDate||''}}
                                </span>
                            </div>
...
<<<<<<< HEAD
            ...
            <div class="bottom">
                <iframe @load="sendToken" id="iframe" :src="`${iframeIp}/#/flight_milepost?showTree=true&flightId=${item.flightId}&type=${data.flightMilestoneType}`" frameborder="0"></iframe>
            </div>
        </el-dialog>
    </div>
=======
        ...
        getStatusStyle() {
            return (opt) => {
                ...
                return {
                    ...
                    color: colorBack === '#ffffff' ? '#333' : '#ffffff',
                }
            }
        },
<<<<<<< HEAD
    ...
    methods: {
        aircraftNoClick(opt) {
            ...
            this.$request
                .post(
                    'flight',
                    'Flight/getTodayAircraftInfo',
                    { aircraftNo: this.data[opt.key] },
                    true
                )
                .then((res) => {
