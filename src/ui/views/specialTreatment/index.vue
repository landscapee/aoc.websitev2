		...
		<div class="content">
			<el-scrollbar style="height:100%">
				<div class="scrollDivHeight">
					<div class="list">
						<div class="listitem" @click="seeDetails(opt)"
							 :class="{listItemNo:getlistitemclass(index),listItemActive:activeObj[opt.id]}"
							 v-for="(opt,index) in data" :key="index+'q'">
							<div class="deleteItem cursor el-icon-circle-close" @click.stop="deleteItem(opt.id)"></div>
							<div class="title">
            ...
            deleteItem(id) {
                ...
                this.$confirm(`确认删除该信息？`, '提示', {
                    type: 'warning',
                     ...
                     this.$request.post('msg', 'notice/delete?id='+id).then((res) => {
                         if (res.code == 200  ) {
